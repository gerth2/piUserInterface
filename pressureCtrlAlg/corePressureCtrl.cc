...
int CorePressureCtrl::update(){
    ...
    desArmForce_Nm = pressureToArmForceLUT->interpolate(desPress);
    ...
    desMotorTorque_Nm = desArmForce_Nm * PADDLE_LEVER_ARM_LENGTH_M/ARM_TO_MOTOR_GEAR_RATIO;
    ...
    armForceError_Nm = desArmForce_Nm - pressureToArmForceLUT->interpolate(actPress);
